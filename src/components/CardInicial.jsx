  ...
  alert("Please,choose a rate button!")
    ...
    return (
        ...
        <div className="flex justify-between mb-6">
          <InputButton value={1} handleChangeRateNote/>
          <InputButton value={2} handleChangeRateNote/>
          <InputButton value={3} handleChangeRateNote/>
          <InputButton value={4} handleChangeRateNote/>
          <InputButton value={5} handleChangeRateNote/>
