...
export function CardInicial({handleChangeRateNote,handleSubmited}) {
    return (
      ...
      <p className="text-light-grey text-sm leading-1 mb-6">Please let us know how we did with your support request. All feedback is appreciated to
        ...
        <button className="bg-orange w-full py-3 rounded-3xl uppercase font-bold tracking-1 hover:bg-white hover:text-orange cursor-pointer trasition duration-400" onClick={handleSubmited}>Submit</button>
    </div>
    )
}